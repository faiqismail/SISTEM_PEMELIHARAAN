...
// FIXED: Hanya untuk Alat Berat Wilayah 1
$selected_bidang = 'Alat Berat Wilayah 1';
...
if (isset($_GET['export'])) {
    ...
    // FIXED: Filter hanya Alat Berat Wilayah 1
    $bidang_condition = " AND k.bidang = 'Alat Berat Wilayah 1'";
    ...
    if ($export_type == 'formatted') {
        ...
        echo '<strong>Bidang:</strong> Alat Berat Wilayah 1<br>';
        ...
        echo '<p>Bidang: Alat Berat Wilayah 1</p>';
        echo '<br>';
...
function getChartDataQty($connection, $id, $type, $period_type, $current_month, $current_year) {
    $data = array();
...
function getOverallChartData($connection, $type, $period_type, $current_month, $current_year) {
    $data = array();
...
// Get overall chart data - FIXED: tanpa parameter bidang karena sudah hardcoded
$overall_chart_data = getOverallChartData($connection, $view_type, $period_type, $current_month, $current_year);
...
<head>
    ...
    <title>Analisa Riwayat - Alat Berat Wilayah 1</title>
    ...
    <div class="page-header">
        <h1>
            ...
            <span class="badge badge-info">
                <i class="fas fa-building"></i> Alat Berat Wilayah 1
            </span>
        </h1>
        <p>Analisa penggunaan sparepart dan jasa dengan visualisasi grafik interaktif - Khusus Alat Berat Wilayah 1</p>
    </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result_sparepart)): 
                                ...
                                $chart_data = getChartDataQty($connection, $row['id_sparepart'], 'sparepart', $period_type, $current_month, $current_year);
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result_jasa)): 
                                $subtotal += $row['total_biaya'];
                                $chart_data = getChartDataQty($connection, $row['id_jasa'], 'jasa', $period_type, $current_month, $current_year);
