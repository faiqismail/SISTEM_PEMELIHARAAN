...
// Fokus hanya pada Alat Berat Wilayah 1
$bidang_target = 'Alat Berat Wilayah 1';

// Mode tampilan: 'all' atau 'carousel'
$display_mode = isset($_GET['mode']) ? $_GET['mode'] : 'all';

// Query hanya untuk Alat Berat Wilayah 1
$sql = "
SELECT
    pp.id_permintaan,
    pp.nomor_pengajuan,
...
<head>
    ...
    <title>Monitoring Alat Berat Wilayah 1</title>
            ...
            <div class="header-container">
                <div class="header-top">
                    <div class="header-title">
                        ...
                        <h1>MONITORING ALAT BERAT WILAYAH 1</h1>
                    </div>
