...
requireAuth('alat_berat_wilayah_1');

/* =====================
   DAFTAR BIDANG (hanya ALAT BERAT WILAYAH 1)
===================== */
$bidang_options = [
...
if (isset($_POST['simpan'])) {
    ...
    $bidang = 'ALAT BERAT WILAYAH 1'; // ← Hardcode bidang
...
// ← Paksa selalu filter hanya ALAT BERAT WILAYAH 1
$where_conditions = ["bidang='ALAT BERAT WILAYAH 1'"];

if (isset($_GET['search'])) {
    $keyword = mysqli_real_escape_string($connection, $_GET['search']);
    $where_conditions[] = "(nopol LIKE '%$keyword%' OR jenis_kendaraan LIKE '%$keyword%')";
}
...
<head>
    ...
    <title>Manajemen Kendaraan - Alat Berat Wilayah 1</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-static {
            width: 100%; padding: 12px 15px; border: 2px solid #e0e0e0;
            border-radius: 8px; font-size: 14px; background: #e9ecef;
        ...
        .bidang-badge {
            display: inline-block; padding: 6px 12px; border-radius: 15px; font-size: 12px;
            font-weight: 600; white-space: nowrap;
            background: linear-gradient(135deg,#fff3e0,#ffe0b2); color:#e65100; border:1px solid #ffb74d;
        }
...
<div class="main-container">
    ...
    <div class="page-header">
        <h1><i class="fas fa-car"></i> Data Asset Armada — Alat Berat Wilayah 1</h1>
    </div>
    ...
    <div class="content-layout">
        ...
        <div class="form-container">
            ...
            <form method="POST">
                ...
                <!-- Bidang (tampilkan sebagai teks statis, tidak bisa diubah) -->
                <div class="form-group">
                    <label class="form-label"><i class="fas fa-building"></i> Bidang</label>
                    <div class="form-static">
                        <i class="fas fa-lock" style="color:#e65100;margin-right:6px;"></i> ALAT BERAT WILAYAH 1
                    </div>
                    <input type="hidden" name="bidang" value="ALAT BERAT WILAYAH 1">
                    <small class="info-text"><i class="fas fa-info-circle"></i> Bidang terkunci: Alat Berat Wilayah 1</small>
                </div>
        ...
        <div class="data-container">
            <div class="data-header">
                <h2 class="data-title"><i class="fas fa-list"></i> Daftar Asset — Alat Berat Wilayah 1</h2>
                <?php
                $aktif       = mysqli_num_rows(mysqli_query($connection, "SELECT id_kendaraan FROM kendaraan WHERE status='Aktif' AND bidang='ALAT BERAT WILAYAH 1'"));
                $tidak_aktif = mysqli_num_rows(mysqli_query($connection, "SELECT id_kendaraan FROM kendaraan WHERE status='Tidak Aktif' AND bidang='ALAT BERAT WILAYAH 1'"));
                ?>
            ...
            <div class="filter-search-container">
                ...
                <div class="search-box">
                    ...
                    <input type="text" id="searchInput" class="search-input"
                           placeholder="Cari nomor asset, jenis..."
                ...
                <table>
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr data-status="<?= htmlspecialchars($k['status']) ?>"
                            ...
                            <td>
                                <span class="bidang-badge"><?= htmlspecialchars($k['bidang']) ?></span>
                            </td>
                        ...
                        <tr>
                            <td colspan="8" class="no-data">
                                ...
                                <p><?= $keyword
                                    ...
                                    : ($filter_status != 'semua' ? "Tidak ada kendaraan dengan status $filter_status" : 'Belum ada data kendaraan Alat Berat Wilayah 1') ?></p>
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
...
document.getElementById('searchInput').addEventListener('input', function() {
    ...
    rows.forEach(row => {
        ...
        const keywordMatch = !keyword || nopol.includes(keyword) || jenis.includes(keyword);
...
// Trigger live search saat page load jika ada keyword
