...
// FIXED: Hanya untuk Alat Berat Wilayah 3
$selected_bidang = 'Alat Berat Wilayah 3';
...
if (isset($_GET['export'])) {
    ...
    // FIXED: Filter hanya Alat Berat Wilayah 3
    $bidang_condition = " AND k.bidang = 'Alat Berat Wilayah 3'";
    ...
    if ($export_type == 'formatted') {
        ...
        echo '<strong>Bidang:</strong> Alat Berat Wilayah 3<br>';
        ...
        echo '<p>Bidang: Alat Berat Wilayah 3</p>';
        echo '<br>';
...
<head>
    ...
    <title>Analisa Riwayat - Alat Berat Wilayah 3</title>
    ...
    <div class="page-header">
        <h1>
            ...
            <span class="badge badge-info">
                <i class="fas fa-building"></i> Alat Berat Wilayah 3
            </span>
        </h1>
        <p>Analisa penggunaan sparepart dan jasa dengan visualisasi grafik interaktif - Khusus Alat Berat Wilayah 3</p>
    </div>
