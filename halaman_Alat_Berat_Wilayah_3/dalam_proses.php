...
// Fokus hanya pada Alat Berat Wilayah 3
$bidang_target = 'Alat Berat Wilayah 3';

// Mode tampilan: 'all' atau 'carousel'
$display_mode = isset($_GET['mode']) ? $_GET['mode'] : 'all';

// Query hanya untuk Alat Berat Wilayah 3
$sql = "
SELECT
    pp.id_permintaan,
    pp.nomor_pengajuan,
...
<head>
    ...
    <title>Monitoring Alat Berat Wilayah 3</title>
            ...
            <div class="header-container">
                <div class="header-top">
                    <div class="header-title">
                        ...
                        <h1>MONITORING Alat Berat Wilayah 3</h1>
                    </div>
