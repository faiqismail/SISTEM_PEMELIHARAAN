...
/* =====================
   DAFTAR BIDANG (hanya ALAT BERAT WILAYAH 3)
===================== */
$bidang_options = [
...
if (isset($_POST['simpan'])) {
    ...
    $bidang = 'ALAT BERAT WILAYAH 3'; // ← Hardcode bidang
...
// ← Paksa selalu filter hanya ALAT BERAT WILAYAH 3
$where_conditions = ["bidang='ALAT BERAT WILAYAH 3'"];
...
<head>
    ...
    <title>Manajemen Kendaraan - ALAT BERAT WILAYAH 3</title>
...
<div class="main-container">
    ...
    <div class="page-header">
        <h1><i class="fas fa-car"></i> Data Asset Armada — ALAT BERAT WILAYAH 3</h1>
    </div>
    ...
    <div class="content-layout">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="form-static">
                        <i class="fas fa-lock" style="color:#e65100;margin-right:6px;"></i> ALAT BERAT WILAYAH 3
                    </div>
                    <input type="hidden" name="bidang" value="ALAT BERAT WILAYAH 3">
                    <small class="info-text"><i class="fas fa-info-circle"></i> Bidang terkunci: ALAT BERAT WILAYAH 3</small>
                </div>
        ...
        <div class="data-container">
            <div class="data-header">
                <h2 class="data-title"><i class="fas fa-list"></i> Daftar Asset — ALAT BERAT WILAYAH 3</h2>
                <?php
                $aktif       = mysqli_num_rows(mysqli_query($connection, "SELECT id_kendaraan FROM kendaraan WHERE status='Aktif' AND bidang='ALAT BERAT WILAYAH 3'"));
                $tidak_aktif = mysqli_num_rows(mysqli_query($connection, "SELECT id_kendaraan FROM kendaraan WHERE status='Tidak Aktif' AND bidang='ALAT BERAT WILAYAH 3'"));
                ?>
                        ...
                        <tr>
                            <td colspan="8" class="no-data">
                                ...
                                <p><?= $keyword
                                    ...
                                    : ($filter_status != 'semua' ? "Tidak ada kendaraan dengan status $filter_status" : 'Belum ada data kendaraan ALAT BERAT WILAYAH 3') ?></p>
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
