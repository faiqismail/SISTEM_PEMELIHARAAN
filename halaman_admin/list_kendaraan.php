...
$where = "WHERE p.status IN ('Diajukan', 'Diperiksa_SA', 'Dikembalikan_sa')";
...
$count_diajukan = mysqli_num_rows(mysqli_query($connection, "SELECT * FROM permintaan_perbaikan WHERE status='Diajukan'"));
$count_diperiksa = mysqli_num_rows(mysqli_query($connection, "SELECT * FROM permintaan_perbaikan WHERE status='Diperiksa_SA'"));
$count_belum_kirim = mysqli_num_rows(mysqli_query($connection, "SELECT * FROM permintaan_perbaikan WHERE status='Dikembalikan_sa' AND persetujuan_pengawas IS NULL"));
$count_menunggu = mysqli_num_rows(mysqli_query($connection, "SELECT * FROM permintaan_perbaikan WHERE status='Dikembalikan_sa' AND persetujuan_pengawas='Menunggu'"));
$count_ditolak = mysqli_num_rows(mysqli_query($connection, "SELECT * FROM permintaan_perbaikan WHERE status='Dikembalikan_sa' AND persetujuan_pengawas='Ditolak'"));
$count_disetujui_pengawas = mysqli_num_rows(mysqli_query($connection, "SELECT * FROM permintaan_perbaikan WHERE status='Dikembalikan_sa' AND persetujuan_pengawas='Disetujui'"));
