...
if (isset($_GET['edit'])) {
    ...
    $q = mysqli_query($connection,"SELECT * FROM sparepart WHERE id_sparepart='$id_edit'");
...
if ($search != '') {
    $where_conditions[] = "(kode_sparepart LIKE '%$search%' OR nama_sparepart LIKE '%$search%')";
}
            ...
            <div class="card rounded-2xl shadow-2xl p-4 sm:p-6">
                    ...
                    <table class="w-full table-fixed min-w-[1100px]">
                        <thead class="text-white sticky top-0" style="background:rgb(9, 120, 83);">
                            <tr>
                                ...
                                <th class="px-3 py-4 text-left font-semibold w-[28%]">Nama Sparepart</th>
                                <th class="px-3 py-4 text-center font-semibold w-[10%]">Satuan</th>
                                <th class="px-3 py-4 text-right font-semibold w-[13%]">Harga</th>
                                <th class="px-3 py-4 text-center font-semibold w-[10%]">Status</th>
                                <th class="px-3 py-4 text-center font-semibold w-[25%]">Keterangan</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200" id="tableBody">
                            ...
                            $q  = mysqli_query(
                                $connection,
                                "SELECT * FROM sparepart $where ORDER BY aktif DESC, kode_sparepart ASC LIMIT $per_page OFFSET $offset"
                            );
                            $no = 0;
                            ...
                            <tr class="table-row <?= $d['aktif'] == 'N' ? 'opacity-60 bg-gray-100' : '' ?>" data-status="<?= $d['aktif'] ?>">
                                ...
                                <td class="px-3 py-4 text-gray-800 w-[28%]">
                                ...
                                <td class="px-3 py-4 text-center w-[25%]">
                ...
                <div class="mt-4 space-y-2">
                    ...
                    <p class="text-sm text-gray-600">
                        ...
                        dari <span class="font-semibold"><?= $total_rows ?></span> data sparepart
                    </p>
