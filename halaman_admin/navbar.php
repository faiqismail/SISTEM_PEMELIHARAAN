...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-menu">
        ...
        <a href="rekanan.php" class="menu-item <?= $current_page == 'rekanan.php' ? 'active' : '' ?>">
            <i class="fas fa-handshake"></i>
            <span>Management Rekanan</span>
        </a>
        
        <a href="master_jasa.php" class="menu-item <?= $current_page == 'master_jasa.php' ? 'active' : '' ?>">
            <i class="fas fa-wrench"></i>
            <span>Management Jasa</span>
        </a>
        
        <a href="master_sparepart.php" class="menu-item <?= $current_page == 'master_sparepart.php' ? 'active' : '' ?>">
