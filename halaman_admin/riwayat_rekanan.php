...
$has_filter = !empty($filter_rekanan) || !empty($filter_bidang) || !empty($filter_nopol) || 
...
// ==================== BUILD WHERE CLAUSE ====================
$where_conditions = ["pp.status = 'Selesai'", "pp.tgl_selesai IS NOT NULL"];
...
<head>
    ...
    <title>Laporan Biaya Perbaikan</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Laporan Transaksi Jasa & Sparepart dengan Status Selesai</p>
        ...
        <div class="filter-section">
            ...
            <form method="GET" action="" id="filterForm">
                <div class="filter-row">
                    ...
                    <div class="filter-group">
                        <label><i class="fas fa-briefcase"></i> Bidang:</label>
                        <select name="bidang" id="bidang">
                            ...
                            ?>
                                <option value="<?= $row['bidang'] ?>" 
                                    <?= $filter_bidang == $row['bidang'] ? 'selected' : '' ?>>
                ...
                <table id="dataTable">
                    ...
                    <tbody>
                        ...
                        if ($result && mysqli_num_rows($result) > 0) {
                                ...
                                if ($current_group_key != $group_key) {
                                    echo "<tr class='group-header'>
                                        <td colspan='13'>
                                            ...
                                            <i class='fas fa-briefcase'></i> BIDANG: " . htmlspecialchars($row['bidang']) . "
                                        </td>
                                    </tr>";
                                }
                            ...
                            echo "<tr><td colspan='13' class='no-data'>
