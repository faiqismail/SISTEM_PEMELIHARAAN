...
// FIXED: Hanya untuk ANGKUTAN DALAM
$selected_bidang = 'ANGKUTAN DALAM';
...
if (isset($_GET['export'])) {
    ...
    // FIXED: Filter hanyaANGKUTAN DALAM
    $bidang_condition = " AND k.bidang = 'ANGKUTAN DALAM'";
    ...
    if ($export_type == 'formatted') {
        ...
        echo '<strong>Bidang:</strong>ANGKUTAN DALAM<br>';
        ...
        echo '<p>Bidang:ANGKUTAN DALAM</p>';
        echo '<br>';
...
<head>
    ...
    <title>Analisa Riwayat -ANGKUTAN DALAM</title>
    ...
    <div class="page-header">
        <h1>
            ...
            <span class="badge badge-info">
                <i class="fas fa-building"></i>ANGKUTAN DALAM
            </span>
        </h1>
        <p>Analisa penggunaan sparepart dan jasa dengan visualisasi grafik interaktif - KhususANGKUTAN DALAM</p>
    </div>
