...
// Fokus hanya pada ANGKUTAN DALAM
$bidang_target = 'ANGKUTAN DALAM';

// Mode tampilan: 'all' atau 'carousel'
$display_mode = isset($_GET['mode']) ? $_GET['mode'] : 'all';

// Query hanya untuk ANGKUTAN DALAM
$sql = "
SELECT
    pp.id_permintaan,
    pp.nomor_pengajuan,
...
<head>
    ...
    <title>Monitoring ANGKUTAN DALAM</title>
            ...
            <div class="header-container">
                <div class="header-top">
                    <div class="header-title">
                        ...
                        <h1>MONITORING ANGKUTAN DALAM</h1>
                    </div>
