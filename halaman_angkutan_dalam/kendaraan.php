...
/* =====================
   DAFTAR BIDANG (hanya ANGKUTAN DALAM)
===================== */
$bidang_options = [
    'ANGKUTAN DALAM'
];
...
if (isset($_POST['simpan'])) {
    ...
    $bidang = 'ANGKUTAN DALAM'; // ← Hardcode bidang
...
// ← Paksa selalu filter hanya ANGKUTAN DALAM
$where_conditions = ["bidang='ANGKUTAN DALAM'"];
...
<head>
    ...
    <title>Manajemen Kendaraan - ANGKUTAN DALAM</title>
...
<div class="main-container">
    ...
    <div class="page-header">
        <h1><i class="fas fa-car"></i> Data Asset Armada — ANGKUTAN DALAM</h1>
    </div>
    ...
    <div class="content-layout">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="form-static">
                        <i class="fas fa-lock" style="color:#e65100;margin-right:6px;"></i> ANGKUTAN DALAM
                    </div>
                    <input type="hidden" name="bidang" value="ANGKUTAN DALAM">
                    <small class="info-text"><i class="fas fa-info-circle"></i> Bidang terkunci: ANGKUTAN DALAM</small>
                </div>
        ...
        <div class="data-container">
            <div class="data-header">
                <h2 class="data-title"><i class="fas fa-list"></i> Daftar Asset — ANGKUTAN DALAM</h2>
                <?php
                $aktif       = mysqli_num_rows(mysqli_query($connection, "SELECT id_kendaraan FROM kendaraan WHERE status='Aktif' AND bidang='ANGKUTAN DALAM'"));
                $tidak_aktif = mysqli_num_rows(mysqli_query($connection, "SELECT id_kendaraan FROM kendaraan WHERE status='Tidak Aktif' AND bidang='ANGKUTAN DALAM'"));
                ?>
                        ...
                        <tr>
                            <td colspan="8" class="no-data">
                                ...
                                <p><?= $keyword
                                    ...
                                    : ($filter_status != 'semua' ? "Tidak ada kendaraan dengan status $filter_status" : 'Belum ada data kendaraan ANGKUTAN DALAM') ?></p>
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
