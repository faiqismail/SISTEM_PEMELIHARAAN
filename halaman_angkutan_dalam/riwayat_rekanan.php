...
$where_conditions = [
    ...
    "k.bidang = 'ANGKUTAN DALAM'" // FILTER TETAP UNTUK BIDANG
];
...
<head>
    ...
    <title>Laporan Biaya Perbaikan - ANGKUTAN DALAM</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Laporan Transaksi Jasa & Sparepart - ANGKUTAN DALAM</p>
