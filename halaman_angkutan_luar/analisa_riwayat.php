...
// FIXED: Hanya untuk ANGKUTAN LUAR
$selected_bidang = 'ANGKUTAN LUAR';
...
if (isset($_GET['export'])) {
    ...
    // FIXED: Filter hanyaANGKUTAN LUAR
    $bidang_condition = " AND k.bidang = 'ANGKUTAN LUAR'";
    ...
    if ($export_type == 'formatted') {
        ...
        echo '<strong>Bidang:</strong>ANGKUTAN LUAR<br>';
...
<head>
    ...
    <title>Analisa Riwayat -ANGKUTAN LUAR</title>
    ...
    <div class="page-header">
        <h1>
            ...
            <span class="badge badge-info">
                <i class="fas fa-building"></i>ANGKUTAN LUAR
            </span>
        </h1>
        <p>Analisa penggunaan sparepart dan jasa dengan visualisasi grafik interaktif - KhususANGKUTAN LUAR</p>
    </div>
