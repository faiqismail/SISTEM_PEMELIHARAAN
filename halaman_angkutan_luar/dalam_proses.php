...
// Fokus hanya pada ANGKUTAN LUAR
$bidang_target = 'ANGKUTAN LUAR';

// Mode tampilan: 'all' atau 'carousel'
$display_mode = isset($_GET['mode']) ? $_GET['mode'] : 'all';

// Query hanya untuk ANGKUTAN LUAR
$sql = "
SELECT
    pp.id_permintaan,
    pp.nomor_pengajuan,
...
<head>
    ...
    <title>Monitoring ANGKUTAN LUAR</title>
            ...
            <div class="header-container">
                <div class="header-top">
                    <div class="header-title">
                        ...
                        <h1>MONITORING ANGKUTAN LUAR</h1>
                    </div>
