...
/* =====================
   DAFTAR BIDANG (hanya ANGKUTAN LUAR)
===================== */
$bidang_options = [
    'ANGKUTAN LUAR'
];
...
if (isset($_POST['simpan'])) {
    ...
    $bidang = 'ANGKUTAN LUAR'; // ← Hardcode bidang
...
// ← Paksa selalu filter hanya ANGKUTAN LUAR
$where_conditions = ["bidang='ANGKUTAN LUAR'"];
...
<head>
    ...
    <title>Manajemen Kendaraan - ANGKUTAN LUAR</title>
...
<div class="main-container">
    ...
    <div class="page-header">
        <h1><i class="fas fa-car"></i> Data Asset Armada — ANGKUTAN LUAR</h1>
    </div>
    ...
    <div class="content-layout">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="form-static">
                        <i class="fas fa-lock" style="color:#e65100;margin-right:6px;"></i> ANGKUTAN LUAR
                    </div>
                    <input type="hidden" name="bidang" value="ANGKUTAN LUAR">
                    <small class="info-text"><i class="fas fa-info-circle"></i> Bidang terkunci: ANGKUTAN LUAR</small>
                </div>
        ...
        <div class="data-container">
            <div class="data-header">
                <h2 class="data-title"><i class="fas fa-list"></i> Daftar Asset — ANGKUTAN LUAR</h2>
                <?php
                $aktif       = mysqli_num_rows(mysqli_query($connection, "SELECT id_kendaraan FROM kendaraan WHERE status='Aktif' AND bidang='ANGKUTAN LUAR'"));
                $tidak_aktif = mysqli_num_rows(mysqli_query($connection, "SELECT id_kendaraan FROM kendaraan WHERE status='Tidak Aktif' AND bidang='ANGKUTAN LUAR'"));
                ?>
                        ...
                        <tr>
                            <td colspan="8" class="no-data">
                                ...
                                <p><?= $keyword
                                    ...
                                    : ($filter_status != 'semua' ? "Tidak ada kendaraan dengan status $filter_status" : 'Belum ada data kendaraan ANGKUTAN LUAR') ?></p>
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
