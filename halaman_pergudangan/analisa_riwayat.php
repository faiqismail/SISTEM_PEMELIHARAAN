...
// FIXED: Hanya untuk pergudangan
$selected_bidang = 'pergudangan';
...
if (isset($_GET['export'])) {
    ...
    // FIXED: Filter hanyapergudangan
    $bidang_condition = " AND k.bidang = 'pergudangan'";
    ...
    if ($export_type == 'formatted') {
        ...
        echo '<strong>Bidang:</strong>pergudangan<br>';
...
<head>
    ...
    <title>Analisa Riwayat -pergudangan</title>
    ...
    <div class="page-header">
        <h1>
            ...
            <span class="badge badge-info">
                <i class="fas fa-building"></i>pergudangan
            </span>
        </h1>
        <p>Analisa penggunaan sparepart dan jasa dengan visualisasi grafik interaktif - Khususpergudangan</p>
    </div>
