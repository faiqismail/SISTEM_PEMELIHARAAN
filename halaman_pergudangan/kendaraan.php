...
/* =====================
   DAFTAR BIDANG (hanya PERGUDANGAN)
===================== */
$bidang_options = [
    'PERGUDANGAN'
];
...
if (isset($_POST['simpan'])) {
    ...
    $bidang = 'PERGUDANGAN'; // ← Hardcode bidang
...
// ← Paksa selalu filter hanya PERGUDANGAN
$where_conditions = ["bidang='PERGUDANGAN'"];
...
<head>
    ...
    <title>Manajemen Kendaraan - PERGUDANGAN</title>
...
<div class="main-container">
    ...
    <div class="page-header">
        <h1><i class="fas fa-car"></i> Data Asset Armada — PERGUDANGAN</h1>
    </div>
    ...
    <div class="content-layout">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="form-static">
                        <i class="fas fa-lock" style="color:#e65100;margin-right:6px;"></i> PERGUDANGAN
                    </div>
                    <input type="hidden" name="bidang" value="PERGUDANGAN">
                    <small class="info-text"><i class="fas fa-info-circle"></i> Bidang terkunci: PERGUDANGAN</small>
                </div>
        ...
        <div class="data-container">
            <div class="data-header">
                <h2 class="data-title"><i class="fas fa-list"></i> Daftar Asset — PERGUDANGAN</h2>
                <?php
                $aktif       = mysqli_num_rows(mysqli_query($connection, "SELECT id_kendaraan FROM kendaraan WHERE status='Aktif' AND bidang='PERGUDANGAN'"));
                $tidak_aktif = mysqli_num_rows(mysqli_query($connection, "SELECT id_kendaraan FROM kendaraan WHERE status='Tidak Aktif' AND bidang='PERGUDANGAN'"));
                ?>
                        ...
                        <tr>
                            <td colspan="8" class="no-data">
                                ...
                                <p><?= $keyword
                                    ...
                                    : ($filter_status != 'semua' ? "Tidak ada kendaraan dengan status $filter_status" : 'Belum ada data kendaraan PERGUDANGAN') ?></p>
                            </td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
