...
// Query untuk mengambil data perbaikan per kendaraan - HANYA pergudangan
$query = "
    SELECT 
        k.id_kendaraan,
        k.nopol,
...
<head>
    ...
    <title>Dashboard Kondisi Kendaraan - pergudangan</title>
...
<body>
    ...
    <div id="pageLoader" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(255,255,255,0.95); z-index: 9999; display: flex; align-items: center; justify-content: center; flex-direction: column;">
        ...
        <div style="font-size: 12px; color: #999; margin-top: 5px;">Periode: <?php echo $analysis_period; ?> bulan | pergudangan</div>
    </div>
    ...
    <div class="main-container">
        ...
        <div class="header">
            ...
            <p>Analisis Performa & Riwayat Perbaikan Asset - pergudangan</p>
        ...
        <div id="vehicleList">
            ...
            <?php else: ?>
                <div class="no-data">
                    ...
                    <p>Belum ada riwayat perbaikan yang tercatat untuk pergudangan</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
